...
* [x] Ativar a conta do usuário _administrador local_ \([CLIQUE AQUI ](https://youtu.be/so_HVEM2VD0)para visualizar o vídeo tutorial\);
...
* [x] Reiniciar o equipamento e efetuar o login com o usuário que seja membro do grupo Suporte\_Admin_\__Local;
